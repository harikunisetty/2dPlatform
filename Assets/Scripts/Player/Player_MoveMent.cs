...
public class Player_MoveMent : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(new Vector3(transform.position.x - 0.03f, transform.position.y, transform.position.z),
        Vector3.down * range);

        Gizmos.color = Color.black;
        Gizmos.DrawRay(new Vector3(transform.position.x + 0.08f, transform.position.y, transform.position.z),
         Vector3.down * range);
    }
}
